...
namespace GLSL
{
    ...
    * defined in GLSL shader programs which is a collection of individual
    * variables. Because this is nearly identical to the variable block type in
    * GLSL this simply inherits from that class.
    */
