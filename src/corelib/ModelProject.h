...
{
    Q_OBJECT
    friend class Command::AbstractProject;
    ...
    QList<Command::AbstractProject*> _redoStack;
    QList<Command::AbstractProject*> _undoStack;
    QPersistentModelIndex _setIndex;
    QString _directoryPath;
    QString _name;
    QString _relativeCodePath;
    bool mutable _modified {true};
    static QList<AbstractBlock*> _copied;
     ...
     */
    public:
    const AbstractBlock* constBlock(
        const QModelIndex& index
    ) const;
