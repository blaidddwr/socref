...
namespace Basic
{
   ...
   private:
      /*!
       * The regular expression used to match the beginning line that causes this
       * parser to start taking input from its parent scanner's source file.
       */
      const QString _beginExp;
      /*!
       * The regular expression used to match the ending line that causes this parser
       * to end taking input from its parent scanner's source file.
       */
      ...
      QStringList _lines;
      /*!
       * True if the first line input has not been given by this parent's scanner.
       * False if the first line has been read or this line parser is set to read the
       * first line of input.
       */
      bool _first {true};
   };
