...
namespace Gui
{
    ...
    * dictionary words contained in the project it is given. This also allows the
    * user to remove words in the list, but does not allow the user to add new
    * words. Adding new words is done through the spell checking dialog interface.
    */
