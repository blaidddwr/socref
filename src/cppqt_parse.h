...
namespace CppQt
{
   ...
   namespace Parse
   {
      ...
      QString createBaseDeclaration(const Function& block, const QString& classScope = QString(), bool initializers = true);
      void addDefinition(QList<Abstract::Parser*>* list, const Function& block);
      void addComments(QList<Abstract::Parser*>* list, const Function& block, int indent = 0);
