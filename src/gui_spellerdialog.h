...
namespace Gui
{
    ...
    * ignore once, or ignore all for each misspelled word it finds. It also provides 
    * suggestions for changing the misspelled words it finds. Lastly it provides a 
    * snippet of the text around the misspelled word to provide context to the user. 
    * This is a persistent dialog and remembers its geometry. 
    * 
   ...
   private:
      ...
      int _length {0};
      /*!
       * The word edit widget of this dialog where the user can edit and fix misspelled 
       * words. 
       */
      QLineEdit* _wordEdit;
      /*!
      ...
      QLabel* _snippetView;
      /*!
       * The suggestions view label of this dialog that displays possible corrections to 
