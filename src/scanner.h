...
/*!
 * This is a scanner that is responsible for parsing an entire source file using
 * a list of parser elements added to it. The parser elements must be added
 * before parsing a source file. A scanner can parse as many times as needed but
 * it should only be used once on the specific file it is meant to be parsing.
 */
...
private:
   ...
   /*!
    * List of parser elements that require reading input lines this scanner uses
    ...
    * parser elements that need input.
    */
   QString _input;
};
