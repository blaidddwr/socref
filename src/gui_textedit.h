...
namespace Gui
{
    ...
    * second way is a spell checker dialog that scans all words of the text
    * allowing for corrections to any misspelled words. A special shortcut is used
    * to activate the spell checker dialog or open the editor into its own dialog.
    *
    * Custom spell checking words is also required for this class to add the
    * ability to have custom words added for spell checking on a per project basis.
    * This functionality requires passing either a block pointer or a pointer to
    * the custom dictionary itself. If a block pointer is given its project's
    * custom dictionary is found.
    */
   ...
   private:
      ...
      /*!
       * True if the dialog popup shortcut is enabled for this editor or false
       * otherwise.
       */
      ...
      /*!
       * Pointer to the spell checking highlighter for this editor. This is null if
