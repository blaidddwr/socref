...
{
   /*!
    * This is a base dialog class that allows any dialog class inheriting it to
    * keep a persistent geometry whenever the dialog is closed and opened again.
    * This is done by using Qt settings, saving the dialog geometry upon
    * destruction and restoring it upon construction or calling a method. A unique
    * key must be given to this class for each dialog inheriting it to avoid Qt
    * setting collisions of saved geometry. If a key is never given to this class
    * then it will not save any geometry.
    */
