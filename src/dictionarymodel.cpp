 ...
 * does.
 *
 * @param word The word that is searched for in this dictionary model.
 *
...
/*!
 * Writes out this model's word list to an XML element, returning the XML
 * element containing all the words.
 *
 *
...
QDomElement DictionaryModel::write(QDomDocument& document) const
{
   ...
   // element for each word. Each word is copied in the child element's enclosing
   // text.
   for (auto word: _list)
   {
...
/*!
 * Adds the given word to this model's word list if it does not already contain
 * it, returning true if the word was added.
 *
 *
 * @return True if the given word was added to this model's word list or false
 *         if the word is already contained in this model.
 */
...
/*!
 * Remove the word at the given index from this model's word list, returning
 * true if it was removed.
 *
 * @param index The index of the word that is removed from this model's word
 *              list.
 *
 * @return True if the word at the given index was removed from this model's
 *         word list or false otherwise.
 */
...
void DictionaryModel::read(const QDomElement& element)
{
   ...
   while ( !node.isNull() )
   {
      // If the child node is an element then append its text to this model's word list.
