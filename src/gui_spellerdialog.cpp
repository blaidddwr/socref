...
/*!
 * Constructs a new spell checker dialog with the given dictionary, language,
 * and qt text document. An optional parent can also be given.
 *
 * @param dictionary The custom dictionary model this spell checker uses to
 *                   check for custom words.
 *
 * @param language The language used with this spell checker's engine.
 *
 * @param document The text document that this spell checker scans for
 *                 misspelled words.
 *
 * @param parent Optional parent that this dialog will block if it is executed
 *               in modal mode.
 */
...
/*!
 * Called when the ignore once button is clicked. This skips the current
 * misspelled word and finds the next one.
 */
...
/*!
 * Queries the user with a dialog if they want to run spell checking again on
 * the parent editor of this dialog.
 *
 * @return True if the user wants to run spell checking again and a misspelled
 *         word was found or false otherwise.
 */
 ...
 *
 * @param match The Qt regular expression match within the given complete text
 *              that is a misspelled word.
 */
 ...
 *
 * @param begin The offset where the misspelled word begins in the given
 *              complete text.
 *
...
/*!
 * Constructs and initializes the word edit portion of the GUI for this new
 * dialog, returning its layout.
 *
...
/*!
 * Constructs and initializes all buttons for this new dialog, returning the
 * layout containing all the buttons.
 *
