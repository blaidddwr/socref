...
{
   /*!
    * This represents the factory that provides all other factories and information
    ...
    * one instance of this factory is available for the entire application. A new
    ...
    * defined project type element names must never change and the two element
    * methods must mirror one another.
    */
   ...
   public:
       ...
       *
       * @param elementName The given element name of the project type that is
       *                    returned if found.
       *
      ...
      /*!
       * This interface returns the element name for the given project type. The
       * element name is used as the tag name in the XML project file to determine
       ...
       * root block that will be used for scanning all source files that match any of
       * the mapped scanner objects returned. The key for the returned mapping are
       * file names that are matched with any source files found in the scanning
       * directory. Ownership of all returned scanner objects are released once
       * returned.
       *
       * @param root Root block of existing project that will be parsed with the
       *             returned mapping of scanner objects.
       *
       * @return Mapping of scanner objects used for scanning source files of the
