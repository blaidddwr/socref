...
{
   /*!
    * This is a spell checking syntax highlighter for its given qt text document.
    * This highlights any misspelled words in its given qt text document by
    * changing its text format so it is visible to the user.
    */
