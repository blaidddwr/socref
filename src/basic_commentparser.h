...
namespace Basic
{
    ...
    * outputs the comments it is provided at initialization. This will wrap
    * comments provided to it to be a given maximum number of columns per line. A
    * header can also be given that is kept to the left of the provided comment.
    * Lastly empty lines can be added that will have the basic comment token
    * provided. Begin and end lines can also be provided that is used to begin and
    * close a comment block when provided to a comment parser element's parent
    * scanner.
    *
    * This parser also provides setting an indentation of spaces before each
    * comment line of its comment block. This indent is not counted towards the
   ...
   private:
      ...
      /*!
       * The middle token that is prepended to each comment line provided by this
      ...
      const QString _end;
      /*!
       * The maximum number of columns per comment line provided by this comment
       * parser element.
       */
      int _maxColumns;
      /*!
