...
/*!
 * Pointer to a copied block that any instance of this class can use to paste
 * into their current block model if possible.
 */
 ...
 * previous model set to it. If a null pointer is given this view is set to
 * empty. This block view does not take ownership of the given model.
 *
 ...
 *
 * @param type The block type created and inserted into this object's model if
 *             it has one.
 */
...
/*!
 * Called when the remove action is triggered. If this object has a valid
 * current index then it is removed from its model.
 */
...
/*!
 * Called when the paste action is triggered. If this object can paste its
 * copied block into its model then it does so.
 */
...
/*!
 * Called when the move up action is triggered. If this object has a valid
 * current index then this will move it up by one.
 */
 ...
 *
 * @param deselected Unused list of indexes that have been deselected by the
 *                   user.
 */
 ...
 *                changed.
 *
 * @param bottomRight The bottom right index of the rectangle of indexes whose
 *                    data has changed. This is not used in this view because
 *                    only one index can change at a time.
 *
 ...
 * right mouse click. This updates its object's current index based off the
 * mouse click position and executes its object's context menu.
 *
 * @param position The relative position within this object's tree view where
...
/*!
 * Constructs and initializes the tree view of this new widget, adding it to
 * this qt splitter.
 */
...
/*!
 * Constructs and initializes the title and detailed view area of this new
 * widget, adding it to the qt splitter.
 */
...
/*!
 * Constructs and initializes the context menu for this new widget, excluding
 * the add menu because it is rebuilt dynamically.
 */
