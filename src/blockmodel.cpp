...
/*!
 * Implements _QAbstractItemModel_ interface. This returns the number of
 * children the block with the given index contains.
 *
 ...
 *
 * @param root Pointer to root block that this model will use or null to set
 *             this model as empty.
 */
 ...
 * signal indicating a block with the given pointer within this model has
 * updated itself.
 *
