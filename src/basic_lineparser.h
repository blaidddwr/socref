...
namespace Basic
{
    ...
    * requires no input and simply provides the lines of text given to it along
    * with an indent of spaces prepended to each line provided to its parent
    * scanner.
    */
   ...
   private:
      /*!
       * The lines used to generate the static output of this line parser to its
       * parent scanner when parsing a source file.
       */
      QStringList _lines;
      /*!
       * The number of space characters prepended to each line of output when this
       * parser generates it for its parent scanner.
       */
      int _indent {0};
   };
}
