...
class TestFunctionCppQtBlock: public QObject
{
    Q_OBJECT
...
void TestFunctionCppQtBlock::initTestCase()
{
...
void TestFunctionCppQtBlock::displayIconProperty()
{
...
void TestFunctionCppQtBlock::displayTextProperty()
{
    using namespace ::Block::Cpp;
    _block->set("test","void",MethodFunctionType,PublicAccess,NoFunctionAssignment,0);
...
void TestFunctionCppQtBlock::isQtInvokable()
{
    using namespace ::Block::Cpp;
    _block->set("test","void",MethodFunctionType,PublicAccess,NoFunctionAssignment,0);
...
void TestFunctionCppQtBlock::isSignal()
{
    using namespace ::Block::Cpp;
    _block->set("test","void",MethodFunctionType,PublicAccess,NoFunctionAssignment,0);
...
void TestFunctionCppQtBlock::isSlot()
{
    using namespace ::Block::Cpp;
    _block->set("test","void",MethodFunctionType,PublicAccess,NoFunctionAssignment,0);
...
void TestFunctionCppQtBlock::cleanupTestCase()
{
    QVERIFY(_parent);
    QVERIFY(_block);
...
QTEST_MAIN(TestFunctionCppQtBlock)
#include "test.moc"
