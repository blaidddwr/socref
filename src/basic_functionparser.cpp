 ...
 *
 * @param inToken The character used by this parent scanner's source file to begin 
 *                a block of execution. 
 *
 * @param outToken The character used by this parent scanner's source file to end a 
 *                 block of execution. 
 *
 * @param commentBegin The characters used by this parent scanner's source file to 
 *                     begin an inline comment line. 
 *
...
/*!
 * Appends the given text to the header regular expression of this function parser, 
 * escaping all characters to be taken literally by the regular expression 
 * interpreter. 
 *
 * @param text Text that is escaped and then appended to the header expression of 
...
/*!
 * Appends the given expression to the header regular expression of this function 
 * parser. The given expression is not escaped and appended without modification to 
 * the header. 
 *
 * @param expression Expression that is appended to the header expression of this 
 *                   function parser. 
 */
 ...
 * this function parser as an inline comment to this object's output lines or a 
 * blank inline comment if there are no more steps of operation to use. 
 *
 * @param line The inline comment given as an input line from the input interface. 
 */
 ...
 *
 * @param index The index of the operation in this object's steps of operation used 
 *              to generate the inline comment. 
 *
