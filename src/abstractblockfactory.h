...
public:
   ...
   /*!
    * This interface makes a new block of the given type and returns its pointer. 
    * The new block is expected to have a null data state. 
    *
   ...
   /*!
    * This interface makes a new root block and returns its pointer. The root block 
    * is used as the root block for all projects of this project type. The new root 
    * block is expected to have a null data state. 
    *
