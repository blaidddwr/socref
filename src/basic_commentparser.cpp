 ...
 *
 * @param middle The middle token prepended to every comment line provided by
 *               this comment parser element except for the special begin and
 *               end lines.
 *
...
/*!
 * Adds the given comment used to generate and provide comment lines to this
 * parser element's parent scanner. The given comment is wrapped into multiple
 * lines to not exceed the maximum columns allowed per line.
 *
 * @param text The commented added to this parser element's list of comments as
 *             a new block.
 */
...
/*!
 * Adds the given comment with a header used to generate and provide comment
 * lines to this parser element's parent scanner. The header is added at the
 * beginning of the first line, and each successive line is adjusted to start
 * where the header ended. The given comment is wrapped into multiple lines to
 * not exceed the maximum columns allowed per line.
 *
 * @param header The special header text added to the beginning of the new
 *               comment.
 *
 ...
 *
 * @param count The number of blank lines added to the lines of this line
 *              parser.
 */
...
/*!
 * Creates and returns a block of comment lines generated from the given header
 * and text. The header can be empty, in that case it is ignored and the text is
 * not justified. If a header is given the text will be justified to the right
 * of the header after the first line. If the text is empty this returns an
 * empty list.
 *
 ...
 *             lines, wrapped to not exceed the maximum number of columns per
 *             line.
 *
